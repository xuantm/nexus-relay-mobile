...
final class MockNexusRelayReconciliationAPI: NexusRelayAPI {
    ...
    func streamUpload(fileURL: URL, fileName: String, folderId: UUID, mimeType: String, fileSize: Int64, clientSyncId: String, progress: HTTPUploadProgressHandler?) async throws -> StreamUploadResponse { fatalError() }
    func initUpload(folderId: UUID, fileName: String, totalSize: Int64, totalChunks: Int, clientSyncId: String) async throws -> InitUploadResponse { fatalError() }
